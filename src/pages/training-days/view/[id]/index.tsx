...
import { getTrainingDayById } from 'apiSdk/training-days';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('training_day', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/training-days/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              {hasAccess('venue', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/venues/view/${data?.venue?.id}`}>
                      {data?.venue?.name}
                    </Link>
                  </Text>
                </Flex>
              ...
              {hasAccess('training_group', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/training-groups/view/${data?.training_group?.id}`}>
                      {data?.training_group?.schedule}
                    </Link>
                  </Text>
                </Flex>
              )}
